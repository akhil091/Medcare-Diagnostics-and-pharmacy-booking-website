...
from Doctors.serializers import AllBookingSerializers
from Doctors.models import AllBooking

from Lab.serializers import OrderSerializers,Lab_ResultSerializers
from Lab.models import Order, Lab_Result
...
class ProfileView(APIView):
    ...
    def get(self, request):
        serialized_profile = ProfileSerializers(User.objects.filter(Phone=self.request.user.Phone),many=True).data
        ...
        serialized_results = Lab_ResultSerializers(Lab_Result.objects.filter(User=self.request.user),many=True).data
        final_response = {
            'Personal_Detail' : serialized_profile,
            'Appointments' : serialized_appointment,
            'Pending_Order' : serialized_order_pending,
